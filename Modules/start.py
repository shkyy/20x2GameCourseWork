...
def start_text():
    name = str(input("To begin the game enter your name: "))

    print("   ------------------------------------------------------------------------------------------------------------")
    print("                                  __HELLO ",name.upper()," WELCOME TO 20 X 2 GAME__                                 ")
    print("   ------------------------------------------------------------------------------------------------------------")
    print("\n                                                -Instructions-                                              \n")

    slow_print("""    -- 20 x 2 is a game played by a human player with a computer. It is played with a dice\n
